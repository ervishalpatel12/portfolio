        ...
        <div className="relative flex flex-col md:flex-row items-center justify-between w-full pt-4 pb-2 my-auto">
          ...
          >
            ...
            <motion.div variants={fadeUpVariants} className="mb-4">
              <p
                ...
                style={{ fontFamily: "'Montserrat', sans-serif" }}
              >
                FULL STACK DEVELOPER <span className="text-[#8C6D4F] mx-1">•</span> Solution Architect <span className="text-[#8C6D4F] mx-1">•</span> Generative AI engineer
              </p>
            </motion.div>
            ...
            >
              <p>
                I architect, build, and scale next-generation digital solutions.
                <br />
                From full stack applications and cloud-native architectures to Generative AI systems, 
                <br/>
                I transform vision into innovative products that drive business growth and user success.
              </p>
            </motion.div>
          ...
          >
            ...
            <div 
              ...
              style={{ fontFamily: "'Montserrat', sans-serif" }}
            >
              <p>Turning complex code into real-world impact.</p>
