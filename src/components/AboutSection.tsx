        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <motion.p
              ...
              style={{ fontFamily: "'Montserrat', sans-serif" }}
            >
              I'm <span className="text-[#F3DBB3] font-medium">Vishal Patel</span>,a Full Stack Developer, Solution Architect, and Generative AI Engineer passionate about building next-generation digital products. I specialize in creating scalable applications, architecting resilient cloud solutions, and integrating Generative AI to unlock new possibilities for businesses and users.
              Where software engineering meets intelligent automation, I transform ideas into robust, future-ready solutions that drive innovation, performance, and growth.
            </motion.p>
            ...
            >
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[10px] font-medium tracking-[0.22em] uppercase text-[#A8988B] mt-0.5">
                  Distributed Microservices Platforms Designed
                </span>
              </div>
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[10px] font-medium tracking-[0.22em] uppercase text-[#A8988B] mt-0.5">
                  Scalable Enterprise Solutions Delivered
                </span>
              </div>
